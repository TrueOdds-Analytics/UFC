...
def evaluate_model_by_name(model_name, model_directory='models/xgboost/jan2024-dec2025/dynamicmatchup sorted 425',
...
def evaluate_all_models(model_directory='models/xgboost/jan2024-dec2025/dynamicmatchup sorted 425',
                        use_calibration=True, calibration_type='isotonic', initial_bankroll=10000,
                        kelly_fraction=0.5, fixed_bet_fraction=0.1, max_bet_percentage=0.1,
...
def main(manual_threshold=None, use_calibration=True, calibration_type='isotonic',
    ...
    if model_directory is None:
        model_directory = 'models/xgboost/jan2024-dec2025/dynamicmatchup sorted 425'
    ...
    # Evaluate all models in directory
        ...
        if use_ensemble:
            for model_file in model_files:
                model_path = os.path.abspath(f'models/xgboost/jan2024-dec2025/dynamicmatchup sorted 425/{model_file}')
                models.append(load_model(model_path, 'xgboost'))
        else:
            model_path = os.path.abspath(
                f'models/xgboost/jan2024-dec2025/dynamicmatchup sorted 425/{model_files[modelnum]}')
            models.append(load_model(model_path, 'xgboost'))
