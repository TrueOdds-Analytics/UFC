...
def create_and_save_calibration_curves(y_test, y_pred_proba_list, use_ensemble=True, output_dir='outputs/calibration_plots',
...
def main(manual_threshold, use_calibration=True, calibration_type='range_based',
    ...
    test_data = pd.read_csv('data/live_data/all_matchups.csv')
