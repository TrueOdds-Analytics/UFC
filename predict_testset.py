...
def main(manual_threshold, use_calibration=True, calibration_type='range_based',
    ...
    """
    Main function with support for range-based calibration
    """
    ...
    test_data = pd.read_csv('data/matchup data/all_matchups.csv')
