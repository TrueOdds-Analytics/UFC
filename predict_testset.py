...
def print_betting_results(total_fights, confident_predictions, correct_confident_predictions, total_bets, correct_bets,
    ...
    fixed_panel = Panel(
        ...
        f"Final bankroll: ${initial_bankroll + fixed_net_profit:.2f}\n"
    ...
    kelly_panel = Panel(
        f"Initial bankroll: ${initial_bankroll:.2f}\n"
        f"Final bankroll: ${initial_bankroll + kelly_net_profit:.2f}\n"
...
def main(optimize_threshold=True, manual_threshold=None, model_type='xgboost', use_calibration=True, initial_bankroll=10000, kelly_fraction=1, fixed_bet_fraction=0.1, max_bet_percentage=0.20):
    ...
    if model_type == 'xgboost':
        model_path = os.path.abspath('models/xgboost/jun2022-jun2024/model_0.7072_auc_diff_0.0229.json')
